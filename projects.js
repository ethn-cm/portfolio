export const projects = [
  {
    ...
    status: "2025",
    context: "Placeholder context — a short framing of the project, the brief, and what role this work played. Replace with real copy.",
  ...
  },
  {
    ...
    status: "2024",
    context:
      "An imagined archive of a place that doesn't exist. Book design, identity, and a small set of moving pieces.",
    hero: { src: "images/utopos/Utopos_Book.png", alt: "Utopos book cover" },
    problem: {
    ...
    strategy: {
      ...
      blocks: [{ type: "placeholders", count: 2, aspect: "1/1" }]
    },
    solution: {
      body:
  ...
  },
  {
    ...
    status: "Ongoing",
    context: "Placeholder context — a short framing of the project, the brief, and what role this work played. Replace with real copy.",
    hero: { src: "images/wip/01.jpg", alt: "WIP book" },
    problem:  { body: "Placeholder problem — describe the constraints, questions, or tensions that shaped the work. Replace with real copy.", blocks: [{ type: "placeholder", aspect: "16/9" }] },
    strategy: { body: "Placeholder strategy — outline the approach, references, and decisions that moved the project forward. Replace with real copy.", blocks: [{ type: "placeholders", count: 2, aspect: "1/1" }] },
    solution: { body: "", blocks: [{ type: "placeholder", aspect: "16/9" }] }
  },
  {
    ...
    status: "Ongoing",
    context: "Placeholder context — a short framing of the project, the brief, and what role this work played. Replace with real copy.",
    hero: { src: "images/utopos/Utopos_Book.png", alt: "" },
    problem:  { body: "Placeholder problem — describe the constraints, questions, or tensions that shaped the work. Replace with real copy.", blocks: [{ type: "placeholder", aspect: "16/9" }] },
    strategy: { body: "Placeholder strategy — outline the approach, references, and decisions that moved the project forward. Replace with real copy.", blocks: [{ type: "placeholders", count: 2, aspect: "1/1" }] },
    solution: { body: "", blocks: [{ type: "placeholder", aspect: "16/9" }] }
  },
  {
    ...
    status: "2025",
    context: "Placeholder context — a short framing of the project, the brief, and what role this work played. Replace with real copy.",
    hero: { src: "images/arsenal/Untitled-1.png", alt: "Arsenal" },
    problem:  { body: "Placeholder problem — describe the constraints, questions, or tensions that shaped the work. Replace with real copy.", blocks: [{ type: "placeholder", aspect: "16/9" }] },
    strategy: { body: "Placeholder strategy — outline the approach, references, and decisions that moved the project forward. Replace with real copy.", blocks: [{ type: "placeholders", count: 2, aspect: "1/1" }] },
    solution: { body: "", blocks: [{ type: "placeholder", aspect: "16/9" }] }
  },
